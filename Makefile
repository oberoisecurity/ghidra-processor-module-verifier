...
LIBS=-lboost_system -lboost_filesystem -lboost_timer -lboost_regex -lboost_program_options -lboost_thread -L . $(GHIDRA_TRUNK)/Ghidra/Features/Decompiler/src/decompile/cpp/libsla.a
